...
\begin{twenty} % Environment for a list with descriptions
    ...
    (i) I \textbf{developed models to analyze Gravitational Waves data}.%, focusing on finding events that are bent or magnified by massive objects (i.e. lensing). 
    (ii) I co-led on a project to \textbf{automate the process of studying lensed events} more efficiently.
	...
	\twentyitem{2018}{Internship as Data Scientist}{DBA Group, Italy}{
        ...
        I worked on developing methods to record and analyse diverse datasets, from meteorological to industrial data, \textbf{using machine learning techniques to predict outcomes and improve data-driven decision-making}
        }
...
%          }\\ 
$\bullet$ \texttt{\#appdevelop \#sideprojects} % \#personalfinance 
          {\small
          ...
          (ii) I participated in a program by VAM, focused on developing AI-driven applications. I implemented a full-stack AI solution while exploring Agentic LLMs, RAG, and prompt engineering (project \href{https://paolocremonese.com/tb}{here}). % Engaging with industry experts and a dynamic AI community.
...
\begin{twenty} 
    \twentyitem{2025}{%
        ...
        % Analytics Program Development Manager
        Partnerships Lead
