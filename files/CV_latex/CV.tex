...
$\bullet$ \texttt{\#personalfinance \#appdevelop \#sideprojects}
          ...
          This project involves the creation of a dedicated \texttt{Python} package designed to efficiently track expenses and investments. %It will be openly accessible on my \href{https://github.com/PaoloCremo}{github page} in the near future. 
          Along with it, I am currently having fun coding %and will soon upload 
          a package to control Spotify custom playlists and a bot to get daily new papers from ArXiv based on user-defined topics.}\\
