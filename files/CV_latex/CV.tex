...
I am a researcher with experience up to the Postdoctoral level, specialised in gravitational waves, with a strong background on data analysis.
...
\begin{twenty} % Environment for a list with descriptions
    ...
    (i) I \textbf{developed tools to analyze Gravitational Waves data}, focusing on finding events that are bent or magnified by massive objects (i.e. lensing). 
    (ii) I worked on a project to organize and \textbf{automate the process of detecting these lensed events} more efficiently.
    (iii) I coded \textbf{a pipeline to automate the creation of setup files}, for cluster computing, for bayesian parameter estimation %of gravitational waves signals from google sheet table 
    (\href{https://github.com/PaoloCremo/runtomation}{PaoloCremo/runtomation}).
    }
	\twentyitem{2018}{Internship as Data Scientist}{DBA Group, Italy}{
        ...
        I worked in a team focused on developing methods to record and analyse diverse datasets, ranging from meteorological to industrial data, \textbf{using machine learning techniques to predict outcomes and improve data-driven decision-making}
        }
...
\begin{twenty} % Environment for a list with descriptions
	\twentyitem{2022}{Ph.D. in Physics}{Szczecin, Poland}{\emph{Gravitational lensing of Gravitational Waves}}
...
$\bullet$ \texttt{\#personalfinance \#appdevelop \#sideprojects}
          {\small 
          I'm developing a personalised mobile app to help manage personal finances. This includes creating a custom \texttt{Python} package to track expenses and investments. On the side, I'm also working on a fun project that lets control Spotify playlists (\href{https://github.com/PaoloCremo/spotify}{PaoloCremo/spotify}) and building a bot to send daily updates of new research papers from ArXiv based on topics of interest (\href{https://github.com/PaoloCremo/paperbot}{PaoloCremo/paperbot}).
          }\\
...
\begin{twenty} 
    \twentyitem{2025}{Client Development Representative}{Data For Good, Vancouver, Canada}{
        I engage nonprofit organizations to identify their data needs, develop tailored strategies for impactful projects, and implement a CRM system to streamline client outreach and relationship management.
        % This experience has enhanced my skills in data strategy, stakeholder engagement, and project scoping while contributing to expanding DFG's nonprofit partnerships and social impact in Vancouver's nonprofit sector.
    }
