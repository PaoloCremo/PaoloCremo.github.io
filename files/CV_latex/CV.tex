...
$\bullet$ \texttt{\#personalfinance \#appdevelop \#sideprojects}
          {\small 
          I'm developing a personalised mobile app to help manage personal finances. This includes creating a custom \texttt{Python} package to track expenses and investments. On the side, I'm also working on a fun project that lets control Spotify playlists (on GitHub @ \href{https://github.com/PaoloCremo/spotify}{PaoloCremo/spotify}) and building a bot to send daily updates of new research papers from ArXiv based on topics of interest (on GitHub @ \href{https://github.com/PaoloCremo/paperbot}{PaoloCremo/paperbot}).
          }\\
